                    ...
                    <div class="card-body">
                        <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="string" class="form-control @error('user_id') is-invalid @enderror" name="user_id" value="{{ old('user_id', $post->user_id) }}" placeholder="Masukkan User Id">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">Category_ID</label>
                                <input type="string" class="form-control @error('category_id') is-invalid @enderror" name="category_id" value="{{ old('category_id', $post->category_id) }}" placeholder="Masukkan Category Id">
